             ...
             <div class="main-div">
                   ...
                   <c:if test="${ !empty loginUser && board.userNo != 1}">                  
                    ...
                    <div style="text-align: center;">
                       <button id="brecom" type="button" onclick="location.href='${ contextPath }/boardMobile/recommend?bno=${ board.bno }'" 
                       class="btn btn-outline-secondary" style="text-align: center;">공감 ${ board.brecom }</button>                                             
                        </div>
                    <hr>                                                             
                   
                    <c:if test="${ loginUser.id eq board.writer_id }">
                    <span class="topContent" ><button class="btn btn-success btn-sm" onclick="location.href='${ contextPath }/boardMobile/updatePage?bno=${ board.bno }&page=${ param.page }'">수정하기</button></span>                
                    <span class="topContent"><button class="btn btn-success btn-sm" onclick="location.href='${ contextPath }/boardMobile/delete?bno=${ board.bno }'">삭제하기</button></span>
                    </c:if>
                     <span class="topContent" style="float:right;"><button class="btn btn-secondary btn-sm" onclick="location.href='${ contextPath }/boardMobile/list?page=${ param.page }'">목록으로</button></span>
                    <br>                  
<!-- 댓글-->   
      <div class="content">
         <div class="outer">
      ...
      /* 댓글 삭제*/
        ...
        function replyDelete(obj){
          var re_no = $(obj).prev().val();
           ...
           $.ajax({
               url : "${ contextPath }/boardMobile/deleteReply",
