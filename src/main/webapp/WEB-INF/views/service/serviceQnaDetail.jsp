          ...
          <div class="col-md-2 rightSpace" style="margin-top: 100px;">
            ...
            <!-- 내용 -->
                ...
                <div class="main-div">
                    ...
                    ${ qna.btitle }</div>
                    <span class="topContent">작성자 : ${ qna.writer_id }</span>
                    <c:if test="${ !empty loginUser }">
                    <i class="far fa-envelope" style="cursor: pointer" onclick="return setUser('${qna.writer_id}',${qna.userNo})"></i>&nbsp;&nbsp;&nbsp;
                    </c:if>
                    <span class="topContent">등록일 : ${ qna.bcreateDate }</span>&nbsp;&nbsp;&nbsp;
                    <span class="topContent"> 조회 : ${ qna.bcount }</span>     
                    <div style="padding-top : 30px; min-height : 200px;">${ qna.bcontent }</div>
                    <hr>               
                    <span class="topContent">
                    	<button type="button" class="btn btn-secondary btn-sm" style="float:right;" onclick="location.href='${contextPath}/qna/list?page=${ param.page }'">목록으로</button>
                    	<c:if test="${ !empty loginUser && loginUser.userNo eq qna.userNo }">
                    		<button type="button" class="btn btn-success btn-sm" style="float:left; margin-right: 10px;" onclick="location.href='${contextPath}/qna/updatePage?bno=${ qna.bno }&page=${ param.page }'">수정</button>
                    		<button type="button" class="btn btn-success btn-sm" style="float:left;" onclick="location.href='${contextPath}/qna/delete?bno=${ qna.bno }'">삭제</button>
                    	</c:if>
                    </span>
                    <br><br>      
