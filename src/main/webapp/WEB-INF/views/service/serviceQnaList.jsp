...
<body>
    ...
    <div class="container">
        <div class="row">
                ...
                <div class="main-div">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr onclick="selectQna(${ qna.bno });">
                            <th scope="row">${ qna.bno }</th>
                            <td style="overflow:hidden;">${ qna.btitle }</td>
                            <td>${ qna.writer_id }</td>
                            <td>${ qna.brecom }</td>
                            <td>${ qna.bcount }</td>
                            <td>${ qna.bcreateDate }</td>
                          </tr>
                          </c:forEach>             
                        </tbody>
                        <tfoot>
						  ...
						  <tr>
							...
							<c:if test="${ !empty loginUser && loginUser.grade ne '블랙회원' }">
								<div class="btnArea" style="float:right;">
									<button class="btn btn-secondary btn-sm" onclick="location.href='${ contextPath }/qna/write'">글쓰기</button>			
								</div>
							</c:if>
							</td>			
						  </tr>
			...
			<form action="${ contextPath }/qna/search" method="get">
			...
			<script>
				function selectQna(bno){
					location.href = '${contextPath}/qna/detail?bno=' + bno + '&page=${pi.currentPage}';
				}		
			</script>    
          </div>           
        </div>               
